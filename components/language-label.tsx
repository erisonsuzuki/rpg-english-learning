...
const COPY = {
  Portuguese: {
    ...
    reviewTitle: "Vocabulário e correções",
    reviewIntro:
      "Receba frases melhoradas e vocabulário-chave do último chat.",
    reviewEmpty: "Envie algumas mensagens no chat para gerar a revisão.",
    reviewAction: "Gerar revisão",
    reviewLoading: "Gerando...",
    reviewShowMore: "Ver mais",
    reviewSectionVocabulary: "Vocabulário",
    reviewSectionSentences: "Melhorias de frases",
    reviewVocabularyEmpty: "Nenhum vocabulário gerado ainda.",
    reviewSentencesEmpty: "Nenhuma melhoria de frase gerada ainda.",
    reviewOriginalLabel: "Original",
    reviewImprovedLabel: "Melhorada",
    reviewExplanationLabel: "Explicação",
    reviewTermLabel: "Termo",
    reviewMeaningLabel: "Significado",
    reviewExampleLabel: "Exemplo",
    reviewError: "Não foi possível gerar a revisão.",
    headerStory: "História",
    headerCharacter: "Personagem",
    headerReview: "Prática",
    ...
    characterQuestionVoiceOrigin: "Como seu personagem aprendeu a falar?",
    ...
    characterQuestionDriver: "O que o move para a aventura?",
    characterQuestionStartingTrinket: "Qual é o item estranho inicial?",
    characterFieldName: "Nome",
    characterFieldClass: "Classe",
    characterFieldBackstory: "História",
    characterFieldStats: "Atributos",
    characterFieldWeakness: "Fraqueza",
    ...
    characterPlaceholderWeakness: "Medo do escuro",
    ...
    llmSettingsTitle: "Configuração do Mestre (IA)",
    correctionStyleLabel: "Rigor das correções",
    correctionStyleOptionNarrative: "Fluxo narrativo (leve)",
    correctionStyleOptionTeacher: "Modo professor (equilibrado)",
    correctionStyleOptionPerfectionist: "Perfeccionista (rigoroso)",
    learningGoalLabel: "Foco principal",
    learningGoalOptionBasics: "Sobrevivência (básico)",
    learningGoalOptionConversation: "Social e diplomacia (conversa)",
    learningGoalOptionReading: "Acadêmico e descritivo (leitura)",
    narratorPersonaLabel: "Tom do narrador",
    narratorPersonaOptionClassic: "O bardo (clássico)",
    narratorPersonaOptionMystery: "A sombra (mistério)",
    narratorPersonaOptionHumor: "O goblin sarcástico (humor)",
    rpgThemeLabel: "Tema do RPG",
    rpgThemePlaceholder: "Fantasia medieval",
  ...
  English: {
    ...
    reviewTitle: "Vocabulary & Corrections",
    reviewIntro:
      "Get improved sentences and key vocabulary from the latest chat.",
    ...
    characterQuestionVoiceOrigin: "How did your character learn to speak?",
    ...
    characterQuestionDriver: "What drives the adventure?",
    characterQuestionStartingTrinket: "What is the strange starting item?",
    characterFieldName: "Name",
    characterFieldClass: "Class",
    characterFieldBackstory: "Backstory",
    characterFieldStats: "Stats",
    characterFieldWeakness: "Weakness",
    ...
    characterPlaceholderWeakness: "Fear of the dark",
    ...
    llmSettingsTitle: "Master Configuration (AI)",
    correctionStyleLabel: "Correction strictness",
    correctionStyleOptionNarrative: "Narrative flow (light)",
    correctionStyleOptionTeacher: "Teacher mode (balanced)",
    correctionStyleOptionPerfectionist: "Perfectionist (strict)",
    learningGoalLabel: "Main learning focus",
    learningGoalOptionBasics: "Survival (basics)",
    learningGoalOptionConversation: "Social and diplomacy (conversation)",
    learningGoalOptionReading: "Academic and descriptive (reading)",
    narratorPersonaLabel: "Narrator tone",
    narratorPersonaOptionClassic: "The Bard (classic)",
    narratorPersonaOptionMystery: "The Shadow (mystery)",
    narratorPersonaOptionHumor: "The Sarcastic Goblin (humor)",
    rpgThemeLabel: "RPG theme",
    rpgThemePlaceholder: "Medieval fantasy",
